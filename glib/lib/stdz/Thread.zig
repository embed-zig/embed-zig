...
//!
//! Usage (after stdz.make):
//!   var t = try stdz.Thread.spawn(.{}, myFunc, .{ &state, 42 });
//!   t.join();
//!
//!   stdz.Thread.Mutex      — mutual exclusion lock
//!   stdz.Thread.Condition   — condition variable
//!   stdz.Thread.RwLock      — reader-writer lock
