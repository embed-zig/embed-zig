...
pub const routes = @import("net/routes.zig");
...
pub const InterfaceInfo = interfaces.Info;
pub const InterfaceFlags = interfaces.Flags;
pub const InterfaceEvent = interfaces.Event;
pub const DefaultRoute = routes.Default;
...
const interfaces_mod = @import("net/interfaces.zig");
const net_types_mod = @import("net/types.zig");
const routes_mod = @import("net/routes.zig");
...
fn makeNet(comptime std: type, comptime Time: type, comptime Sync: type, comptime Task: type, comptime ContextApi: type, comptime impl: type) type {
    ...
    return struct {
        ...
        pub const InterfaceId = net_types_mod.InterfaceId;
        pub const AddressFamily = net_types_mod.AddressFamily;
        pub const AddressInfo = net_types_mod.AddressInfo;
        pub const InterfaceInfo = interfaces_mod.Info;
        pub const InterfaceFlags = interfaces_mod.Flags;
        pub const InterfaceEvent = interfaces_mod.Event;
        pub const DefaultRoute = routes_mod.Default;
        pub const interfaces = interfaces_mod.make(std, @This(), impl);
        pub const routes = routes_mod.make(std, @This(), impl);
