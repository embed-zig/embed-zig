...
pub fn TestRunner() glib.testing.TestRunner {
    const Runner = struct {
        ...
        fn checkFixture(allocator: std.mem.Allocator) !void {
            ...
            const _sor_CamelSchema = Spec.findNamed(Spec.SchemaOrRef, components.schemas, "CamelSchema") orelse return error.FixtureMismatch;
            switch (_sor_CamelSchema) {
                .reference => |r| {
                    _ = r.ref_path;
                },
                .schema => |sch| {
            ...
            const _sor_pascalSchema = Spec.findNamed(Spec.SchemaOrRef, components.schemas, "pascalSchema") orelse return error.FixtureMismatch;
            switch (_sor_pascalSchema) {
                .reference => |r| {
                    _ = r.ref_path;
                },
                .schema => |sch| {
            ...
            const _sor_Foo = Spec.findNamed(Spec.SchemaOrRef, components.schemas, "Foo") orelse return error.FixtureMismatch;
            switch (_sor_Foo) {
                .reference => |r| {
                    _ = r.ref_path;
                },
