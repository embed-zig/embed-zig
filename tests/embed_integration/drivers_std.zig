pub const meta = .{
    ...
    .filter = "embed/drivers/integration/std",
    .label = .integration,
};
...
test "embed/drivers/integration/std" {
    ...
    t.run("embed/drivers/integration/std", drivers.test_runner.integration.make(gstd.runtime));
