...
const apps_unit_base_modules = .{
    @import("apps_unit/glib_unit_test_std.zig"),
    @import("apps_unit/glib_unit_test_mime.zig"),
    @import("apps_unit/glib_unit_test_testing.zig"),
    @import("apps_unit/glib_unit_test_io.zig"),
    @import("apps_unit/glib_unit_test_context.zig"),
    @import("apps_unit/glib_unit_test_sync.zig"),
    @import("apps_unit/glib_unit_test_net.zig"),
};

const apps_integration_base_modules = .{
    @import("apps_integration/glib_integration_test_sync.zig"),
    @import("apps_integration/glib_integration_test_net.zig"),
};
...
const apps_zux_base_modules = .{
    ...
    @import("apps_zux/command_console.zig"),
