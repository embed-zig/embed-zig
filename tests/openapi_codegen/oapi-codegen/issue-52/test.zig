...
pub fn TestRunner() glib.testing.TestRunner {
    const Runner = struct {
        ...
        fn checkFixture(allocator: std.mem.Allocator) !void {
            ...
            const _sor_Value = Spec.findNamed(Spec.SchemaOrRef, components.schemas, "Value") orelse return error.FixtureMismatch;
            switch (_sor_Value) {
                .reference => |r| {
                    _ = r.ref_path;
                },
            ...
            const _sor_ArrayValue = Spec.findNamed(Spec.SchemaOrRef, components.schemas, "ArrayValue") orelse return error.FixtureMismatch;
            switch (_sor_ArrayValue) {
                .reference => |r| {
                    _ = r.ref_path;
                },
                .schema => |sch| {
