...
const tls_mod = test_exports.tls_mod;
const dns_mod = test_exports.dns_mod;
const url_mod = test_exports.url_mod;
const request_mod = test_exports.request_mod;
const buildHttpRequest = test_exports.buildHttpRequest;
const findHeaderEnd = test_exports.findHeaderEnd;
const parseContentLength = test_exports.parseContentLength;
const isResponseComplete = test_exports.isResponseComplete;
const parseHttpResponse = test_exports.parseHttpResponse;
