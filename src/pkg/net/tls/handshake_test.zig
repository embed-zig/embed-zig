...
const common = test_exports.common;
const extensions = test_exports.extensions;
const record = test_exports.record;
const kdf = test_exports.kdf;
const HandshakeType = test_exports.HandshakeType;
const ProtocolVersion = test_exports.ProtocolVersion;
const CipherSuite = test_exports.CipherSuite;
const NamedGroup = test_exports.NamedGroup;
const SignatureScheme = test_exports.SignatureScheme;
const ContentType = test_exports.ContentType;
const X25519KeyExchange = test_exports.X25519KeyExchange;
const P256KeyExchange = test_exports.P256KeyExchange;
const TranscriptHash = test_exports.TranscriptHash;
const Tls12Prf = test_exports.Tls12Prf;
