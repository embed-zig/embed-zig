...
const module = @import("client.zig");
...
const handshake = test_exports.handshake;
const ProtocolVersion = test_exports.ProtocolVersion;
const CipherSuite = test_exports.CipherSuite;
const AlertDescription = test_exports.AlertDescription;
const TestMockConn = test_exports.TestMockConn;
const ConcurrentPipeConn = test_exports.ConcurrentPipeConn;
