...
const DohHosts = module.DohHosts;
const ServerLists = module.ServerLists;
const DnsError = module.DnsError;
const Protocol = module.Protocol;
const Resolver = module.Resolver;
const ResolverWithTls = module.ResolverWithTls;
const buildHttpRequest = module.buildHttpRequest;
const buildQuery = module.buildQuery;
const parseResponse = module.parseResponse;
const formatIpv4 = module.formatIpv4;
const runtime = test_exports.runtime;
const conn_mod = test_exports.conn_mod;
const tls = test_exports.tls;
const validateDomainResolver = test_exports.validateDomainResolver;
const ResolverImpl = test_exports.ResolverImpl;
const findHttpBody = test_exports.findHttpBody;
const parseIpv4String = test_exports.parseIpv4String;
const TestMockSocket = test_exports.TestMockSocket;
const isAliDnsIp = test_exports.isAliDnsIp;
