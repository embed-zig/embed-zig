...
const module = @import("engine.zig");
...
const mixer_mod = test_exports.mixer_mod;
const obuf_mod = test_exports.obuf_mod;
const resampler_mod = test_exports.resampler_mod;
const runtime = test_exports.runtime;
const Allocator = test_exports.Allocator;
const Format = test_exports.Format;
