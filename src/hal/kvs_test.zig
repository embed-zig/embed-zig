...
test "kvs wrapper" {
    const Mock = struct {
        ...
        pub fn getU32(self: *@This(), _: []const u8) KvsError!u32 {
            return self.value_u32 orelse error.NotFound;
        }
        pub fn setU32(self: *@This(), _: []const u8, value: u32) KvsError!void {
            self.value_u32 = value;
        }
        pub fn getString(self: *@This(), _: []const u8, buf: []u8) KvsError![]const u8 {
            const s = self.value_str orelse return error.NotFound;
            if (buf.len < s.len) return error.BufferTooSmall;
            @memcpy(buf[0..s.len], s);
            return buf[0..s.len];
        }
        pub fn setString(self: *@This(), _: []const u8, value: []const u8) KvsError!void {
            self.value_str = value;
        }
        pub fn getI32(self: *@This(), key: []const u8) KvsError!i32 {
            return @bitCast(try self.getU32(key));
        }
        pub fn setI32(self: *@This(), key: []const u8, value: i32) KvsError!void {
            return self.setU32(key, @bitCast(value));
        }
        pub fn erase(self: *@This(), _: []const u8) KvsError!void {
            self.value_u32 = null;
            self.value_str = null;
        }
        pub fn eraseAll(self: *@This()) KvsError!void {
            self.value_u32 = null;
            self.value_str = null;
        }
        pub fn commit(self: *@This()) KvsError!void {
            self.commits += 1;
        }
    };

    const Kvs = from(struct {
