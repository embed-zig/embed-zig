...
extern fn rtos_create_thread(thread: *common.RawThread, priority: u8, name: [*:0]const u8, function: common.ThreadFn, stack_size: u32, arg: ?*anyopaque) c_int;
...
fn createThread(
    ...
    return rtos_create_thread(handle, priority, name, entry, stack_size, arg);
}
