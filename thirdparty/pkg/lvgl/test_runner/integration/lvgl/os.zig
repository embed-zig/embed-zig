        ...
        pub fn run(self: *@This(), t: *glib.testing.T, allocator: glib.std.mem.Allocator) bool {
            ...
            const Cases = struct {
                ...
                fn customMutexLifecycle() !void {
                    var mutex = std.mem.zeroes(binding.Mutex);
                ...
                fn customThreadAndSyncLifecycle() !void {
                    var sync = std.mem.zeroes(binding.ThreadSync);
                    ...
                    var thread = std.mem.zeroes(binding.Thread);
                    ...
                    var did_run = std.atomic.Value(bool).init(false);
