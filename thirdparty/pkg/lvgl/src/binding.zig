...
pub const DisplayFlushCb = c.lv_display_flush_cb_t;
...
pub const lv_obj_move_foreground = c.lv_obj_move_foreground;
...
pub const lv_obj_set_style_pad_hor = c.lv_obj_set_style_pad_hor;
...
pub const lv_obj_invalidate = c.lv_obj_invalidate;
...
pub const lv_image_set_scale = c.lv_image_set_scale;
