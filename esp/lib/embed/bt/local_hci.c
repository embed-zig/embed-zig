...
int esp_embed_bt_local_hci_init(void) {
...
int esp_embed_bt_local_hci_send(const uint8_t *data, size_t len, uint32_t timeout_ms) {
...
int esp_embed_bt_local_hci_recv(uint8_t *out, size_t cap, size_t *out_len, uint32_t timeout_ms) {
