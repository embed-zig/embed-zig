...
const component_spec = @embedFile("spec/component_adc.json");
...
pub fn make(comptime platform_ctx: type, comptime platform_grt: type) type {
    return common.make(component_spec, "chant-adc", platform_ctx, platform_grt);
}
...
pub fn run(comptime platform_ctx: type, comptime platform_grt: type) !void {
    return common.run(component_spec, "chant-adc", "chant-adc/stories", platform_ctx, platform_grt);
}
