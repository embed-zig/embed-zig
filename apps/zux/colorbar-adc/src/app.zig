...
pub const SpecType = blk: {
    ...
    builder.addSpecSlices(&.{
        ...
        @embedFile("spec/user_stories/gpio_click_targets_split_7_colors.json"),
        @embedFile("spec/user_stories/adc_vol_minus_targets_red.json"),
        @embedFile("spec/user_stories/adc_vol_plus_targets_orange.json"),
        @embedFile("spec/user_stories/adc_left_targets_yellow.json"),
        @embedFile("spec/user_stories/adc_right_targets_green.json"),
        @embedFile("spec/user_stories/adc_up_targets_cyan.json"),
        @embedFile("spec/user_stories/adc_down_targets_blue.json"),
        @embedFile("spec/user_stories/adc_rec_targets_violet.json"),
...
pub fn make(comptime platform_ctx: type, comptime platform_grt: type) type {
    return launcher.make(struct {
        ...
        pub const title = "colorbar-adc";
        pub const description = "GPIO and ADC grouped button driven display colorbar test.";
