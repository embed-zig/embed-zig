...
const zux_ble_speed_test = @import("zux/ble-speed-test/build.zig");
const zux_adc_group_debug = @import("zux/adc-group-debug/build.zig");
const zux_archive_smoke = @import("zux/archive-smoke/build.zig");
const zux_button_ledstrip = @import("zux/button-ledstrip/build.zig");
const zux_chant_app = @import("zux/chant/build.zig");
...
pub fn build(b: *std.Build) void {
    ...
    zux_adc_group_debug.register(&registry);
    zux_archive_smoke.register(&registry);
    zux_ble_speed_test.register(&registry);
    zux_button_ledstrip.register(&registry);
    zux_chant_app.register(&registry);
