pub fn register(registry: anytype) void {
    ...
    registry.add("glib_integration-test-sync", registry.b.addModule("glib_integration-test-sync", .{
        .root_source_file = registry.b.path("glib/integration-test/sync/src/app.zig"),
        .target = registry.target,
        .optimize = registry.optimize,
        .imports = &.{
