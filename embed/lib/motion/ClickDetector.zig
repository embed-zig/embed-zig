...
pub fn TestRunner(comptime grt: type) glib.testing.TestRunner {
    const TestCase = struct {
        ...
        fn testReleaseAfterFlushedLongPressEmitsUpdatedDuration() !void {
            ...
            try grt.std.testing.expectEqual(@as(glib.time.instant.Time, 10), first_action.pressed_at);
            ...
            try grt.std.testing.expectEqual(@as(glib.time.instant.Time, 10), release_action.pressed_at);
        ...
        fn testHeldSamplesAfterLongPressEmitCumulativeDuration() !void {
            ...
            try grt.std.testing.expectEqual(@as(glib.time.instant.Time, 10), second_action.pressed_at);
            ...
            try grt.std.testing.expectEqual(@as(glib.time.instant.Time, 10), third_action.pressed_at);
