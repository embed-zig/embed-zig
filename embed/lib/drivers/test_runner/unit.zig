...
const Dbi = @import("../display/Dbi.zig");
...
const Flush = @import("../display/Flush.zig");
...
const Ft5x06 = @import("../touch/ft5x06.zig");
const Gt911 = @import("../touch/gt911.zig");
...
pub fn make(comptime grt: type) glib.testing.TestRunner {
    const Runner = struct {
        ...
        pub fn run(self: *@This(), t: *glib.testing.T, allocator: glib.std.mem.Allocator) bool {
            ...
            t.run("Display/Dbi", Dbi.TestRunner(grt));
            ...
            t.run("Display/Flush", Flush.TestRunner(grt));
            ...
            t.run("Ft5x06", Ft5x06.TestRunner(grt));
            t.run("Gt911", Gt911.TestRunner(grt));
