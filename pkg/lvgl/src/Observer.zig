...
pub fn TestRunner(comptime lib: type) testing_api.TestRunner {
    ...
    const Runner = struct {
        ...
        pub fn run(self: *@This(), t: *testing_api.T, allocator: lib.mem.Allocator) bool {
            ...
            t.run("lvgl/unit_tests/Observer/raw_handle_roundtrip", testing_api.TestRunner.fromFn(lib, 0, Impl.raw_handle_roundtrip));
            t.run("lvgl/unit_tests/Observer/can_observe_subject_updates", testing_api.TestRunner.fromFn(lib, 0, Impl.can_observe_subject_updates));
            t.run("lvgl/unit_tests/Observer/remove_stops_future_subject_notifications", testing_api.TestRunner.fromFn(lib, 0, Impl.remove_stops_future_subject_notifications));
            return t.wait();
        }
