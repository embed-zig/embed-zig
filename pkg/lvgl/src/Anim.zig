...
pub fn TestRunner(comptime lib: type) testing_api.TestRunner {
    ...
    const Runner = struct {
        ...
        pub fn run(self: *@This(), t: *testing_api.T, allocator: lib.mem.Allocator) bool {
            ...
            t.run("lvgl/unit_tests/Anim/descriptor_configures_core_fields", testing_api.TestRunner.fromFn(lib, 0, Impl.descriptor_configures_core_fields));
            t.run("lvgl/unit_tests/Anim/pause_state_toggles_through_lvgl_api", testing_api.TestRunner.fromFn(lib, 0, Impl.pause_state_toggles_through_lvgl_api));
            return t.wait();
        }
