...
pub const VTable = struct {
    check_fn: *const fn (ctx: *anyopaque, draw: DrawArgs) Display.Error!bool,
};
...
pub fn from(comptime T: type, self: *T) @This() {
    const Adapter = struct {
        fn checkFn(ctx: *anyopaque, draw: DrawArgs) Display.Error!bool {
...
pub fn check(self: *const @This(), draw: DrawArgs) Display.Error!bool {
