...
pub fn build(b: *std.Build) void {
    ...
    const ap = addStaticLib(b, "gpio_smoke_ap_zig", "ap/main.zig", context.zig_target, optimize, bk_module, build_config_module);
    const cp = addStaticLib(b, "gpio_smoke_cp_zig", "cp/main.zig", context.zig_target, optimize, bk_module, build_config_module);
    ...
    const app = bk.armino.addDualCoreApp(b, "gpio_smoke", .{
        .context = context,
    ...
    const build_step = b.step("build", "Build the BK GPIO smoke example");
