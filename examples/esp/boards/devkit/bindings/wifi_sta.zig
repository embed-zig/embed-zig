...
pub extern fn devkit_wifi_sta_init() c_int;
pub extern fn devkit_wifi_sta_set_event_handler(ctx: ?*anyopaque, cb: ?EventCallback) void;
pub extern fn devkit_wifi_sta_start_scan(
    ssid_ptr: [*]const u8,
    ssid_len: usize,
    channel: u8,
    show_hidden: bool,
...
pub extern fn devkit_wifi_sta_stop_scan() void;
pub extern fn devkit_wifi_sta_connect_blocking(
    ssid_ptr: [*]const u8,
    ssid_len: usize,
...
pub extern fn devkit_wifi_sta_disconnect() void;
pub extern fn devkit_wifi_sta_state() c_int;
