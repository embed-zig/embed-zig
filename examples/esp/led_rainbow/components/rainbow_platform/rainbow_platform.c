...
#define RAINBOW_GPIO_NUM 48

static const char *TAG = "rainbow_platform";

static led_strip_handle_t s_led_strip;

int esp_example_rainbow_init(void)
{
    if (s_led_strip != NULL) {
        return ESP_OK;
    }
    ...
    led_strip_config_t strip_config = {
        .strip_gpio_num = RAINBOW_GPIO_NUM,
        .max_leds = 1,
    };
...
int esp_example_rainbow_set_rgb(uint8_t r, uint8_t g, uint8_t b)
{
