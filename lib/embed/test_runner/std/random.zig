...
pub fn run(comptime lib: type) !void {
    const log = lib.log.scoped(.random);
...
fn bytesAndBooleanTests(comptime lib: type) !void {
    ...
    log.info("Random: bytes+boolean ok", .{});
}
...
fn rangeTests(comptime lib: type) !void {
    ...
    log.info("Random: range helpers ok", .{});
}
...
fn floatTests(comptime lib: type) !void {
    ...
    log.info("Random: float+floatNorm+floatExp ok", .{});
}
...
fn shuffleTests(comptime lib: type) !void {
    ...
    log.info("Random: shuffle+shuffleWithIndex ok", .{});
}
...
fn weightedAndLimitTests(comptime lib: type) !void {
    ...
    log.info("Random: weightedIndex+limitRangeBiased ok", .{});
}
